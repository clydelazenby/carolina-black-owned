"""
Django settings for Carolina Black Owned backend.
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@carolinablackowned.com')

# Stripe configuration (test mode for mock payments)
