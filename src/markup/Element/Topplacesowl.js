				...
				<div className="section-full bg-gray content-inner about-us">
					<div className="container-fluid">
						<div className="section-head text-black text-center">
							...
							<p>In our "Top Trending Places" section, discover buzzworthy Black-owned businesses in Charlotte, Raleigh, Myrtle Beach, and Charleston that are setting trends in food, tech, and lifestyle.</p>
						</div>
